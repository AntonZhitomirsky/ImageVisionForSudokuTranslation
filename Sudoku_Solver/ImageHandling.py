...
class Image:
    ...
    def compress(self, compression_filter_size=1, dynamic_size=1, divisor=1.1):
        """
        ...
        compressed = self.__compress(compression_filter_size, compression_filter_size)
